...
from .views import (
    DailyPoolView, TriggerPoolView, SelectCandidateView, PassCandidateView,
    AdminTestView, AdminTestUserPoolView, UserPreferenceView, PoolPreviewView
)  # imports our views
...
urlpatterns = [
    ...
    path('preferences/', UserPreferenceView.as_view(), name='user-preferences'),  # GET/PUT /api/discovery/preferences/
    path('pool-preview/', PoolPreviewView.as_view(), name='pool-preview'),  # GET /api/discovery/pool-preview/
